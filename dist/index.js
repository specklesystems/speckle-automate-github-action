...
const http_client_1 = __nccwpck_require__(246);
const auth_1 = __nccwpck_require__(38);
...
const pm = __importStar(__nccwpck_require__(198));
...
async function processSpeckleFunction(opts) {
...
async function run() {
    try {
        ...
        const { functionId, versionId, imageName, dockerfilePath, dockerContextPath } = await processSpeckleFunction({
