...
/* harmony import */ var node_readline__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1747);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5997);
/* harmony import */ var _shared_consola_36c0034f_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9128);
/* harmony import */ var tty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6224);
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1245);
/* harmony import */ var _core_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1316);
/* harmony import */ var _shared_consola_06ad8a64_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3307);
...
let tty = tty__WEBPACK_IMPORTED_MODULE_4__;
...
const l = /*@__PURE__*/(0,_shared_consola_36c0034f_mjs__WEBPACK_IMPORTED_MODULE_3__.g)(picocolorsExports);
...
const unicode = (0,_shared_consola_36c0034f_mjs__WEBPACK_IMPORTED_MODULE_3__.i)();
...
const symbol = (state) => {
  switch (state) {
    case "initial":
    case "active": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_STEP_ACTIVE);
    }
    case "cancel": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.red */ .O9.red(S_STEP_CANCEL);
    }
    case "error": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(S_STEP_ERROR);
    }
    case "submit": {
      return _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.green */ .O9.green(S_STEP_SUBMIT);
    }
  }
};
const text = (opts) => {
  return new oD({
    ...
    render() {
      const title = `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)}
${symbol(this.state)} ${opts.message}
`;
      const placeholder = opts.placeholder ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.inverse */ .O9.inverse(opts.placeholder[0]) + _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(opts.placeholder.slice(1)) : _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.inverse */ .O9.inverse(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.hidden */ .O9.hidden("_"));
      const value = this.value ? this.valueWithCursor : placeholder;
      switch (this.state) {
        case "error": {
          return `${title.trim()}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(
            S_BAR
          )} ${value}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(S_BAR_END)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(
            this.error
          )}
`;
        }
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(
            this.value || opts.placeholder
          )}`;
        }
        case "cancel": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.strikethrough */ .O9.strikethrough(
            _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(this.value ?? "")
          )}${this.value?.trim() ? "\n" + _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR) : ""}`;
        }
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_BAR)} ${value}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(
            S_BAR_END
          )}
`;
        }
...
`;
      ...
      switch (this.state) {
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(value)}`;
        }
        case "cancel": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.strikethrough */ .O9.strikethrough(
            _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(value)
          )}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)}`;
        }
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_BAR)} ${this.value ? `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.green */ .O9.green(S_RADIO_ACTIVE)} ${active}` : `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(S_RADIO_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(active)}`} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim("/")} ${this.value ? `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(S_RADIO_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(inactive)}` : `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.green */ .O9.green(S_RADIO_ACTIVE)} ${inactive}`}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_BAR_END)}
`;
        }
      }
    }
...
const select = (opts) => {
  const opt = (option, state) => {
    ...
    switch (state) {
      case "active": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.green */ .O9.green(S_RADIO_ACTIVE)} ${label} ${option.hint ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(`(${option.hint})`) : ""}`;
      }
      case "selected": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(label)}`;
      }
      case "cancelled": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.strikethrough */ .O9.strikethrough(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(label))}`;
      }
    }
    return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(S_RADIO_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(label)}`;
  };
  return new ED({
...
`;
      switch (this.state) {
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)} ${opt(
...
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)}`;
        ...
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_BAR)} ${this.options.map(
            (option, i) => opt(option, i === this.cursor ? "active" : "inactive")
          ).join(`
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_BAR)}  `)}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_BAR_END)}
`;
        }
      }
...
const multiselect = (opts) => {
  const opt = (option, state) => {
    ...
    switch (state) {
      case "active": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_CHECKBOX_ACTIVE)} ${label} ${option.hint ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(`(${option.hint})`) : ""}`;
      }
      case "selected": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.green */ .O9.green(S_CHECKBOX_SELECTED)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(label)}`;
      }
      case "cancelled": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.strikethrough */ .O9.strikethrough(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(label))}`;
      }
      case "active-selected": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.green */ .O9.green(S_CHECKBOX_SELECTED)} ${label} ${option.hint ? _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(`(${option.hint})`) : ""}`;
      }
      case "submitted": {
        return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(label)}`;
      }
    }
    return `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(S_CHECKBOX_INACTIVE)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(label)}`;
  };
  return new iD({
    options: opts.options,
...
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.reset */ .O9.reset(
          _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(
            `Press ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(
              _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.bgWhite */ .O9.bgWhite(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.inverse */ .O9.inverse(" space "))
            )} to select, ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(
              _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.bgWhite */ .O9.bgWhite(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.inverse */ .O9.inverse(" enter "))
            )} to submit`
          )
        )}`;
      }
...
`;
      switch (this.state) {
        case "submit": {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)} ${this.options.filter(({ value }) => this.value.includes(value)).map((option) => opt(option, "submitted")).join(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(", ")) || _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim("none")}`;
        }
        case "cancel": {
          const label = this.options.filter(({ value }) => this.value.includes(value)).map((option) => opt(option, "cancelled")).join(_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.dim */ .O9.dim(", "));
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)} ${label.trim() ? `${label}
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.gray */ .O9.gray(S_BAR)}` : ""}`;
        }
        case "error": {
          const footer = this.error.split("\n").map(
            (ln, i) => i === 0 ? `${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(S_BAR_END)} ${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(ln)}` : `   ${ln}`
          ).join("\n");
          return title + _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(S_BAR) + "  " + this.options.map((option, i) => {
...
${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.yellow */ .O9.yellow(S_BAR)}  `) + "\n" + footer + "\n";
        }
        default: {
          return `${title}${_utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .colors.cyan */ .O9.cyan(S_BAR)} ${this.options.map((option, i) => {
            const selected = this.value.includes(option.value);
            const active = i === this.cursor;
            if (active && selected) {
              return opt(option, "active-selected");
