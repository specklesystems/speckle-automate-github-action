...
/* harmony export */   "B$": () => (/* binding */ LogLevels),
/* harmony export */   "eK": () => (/* binding */ createConsola)
/* harmony export */ });
/* unused harmony exports Consola, LogTypes */
const LogLevels = {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "B": () => (/* binding */ BasicReporter),
/* harmony export */   "p": () => (/* binding */ parseStack)
/* harmony export */ });
...
function parseStack(stack) {
  const cwd = process.cwd() + node_path__WEBPACK_IMPORTED_MODULE_1__.sep;
...
class BasicReporter {
  ...
  formatArgs(args, opts) {
    ...
    return (0,node_util__WEBPACK_IMPORTED_MODULE_0__.formatWithOptions)(opts, ..._args);
  }
...
/* harmony export */   "i": () => (/* binding */ isUnicodeSupported)
/* harmony export */ });
/* unused harmony exports a, c */
/* harmony import */ var _core_mjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(1316);
/* harmony import */ var _consola_06ad8a64_mjs__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(3307);
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(7742);
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(1245);
...
function isUnicodeSupported() {
	if (node_process__WEBPACK_IMPORTED_MODULE_2__.platform !== 'win32') {
		return node_process__WEBPACK_IMPORTED_MODULE_2__.env.TERM !== 'linux'; // Linux console (kernel)
	}

	return Boolean(node_process__WEBPACK_IMPORTED_MODULE_2__.env.CI)
		|| Boolean(node_process__WEBPACK_IMPORTED_MODULE_2__.env.WT_SESSION) // Windows Terminal
		|| Boolean(node_process__WEBPACK_IMPORTED_MODULE_2__.env.TERMINUS_SUBLIME) // Terminus (<0.2.27)
		|| node_process__WEBPACK_IMPORTED_MODULE_2__.env.ConEmuTask === '{cmd::Cmder}' // ConEmu and cmder
		|| node_process__WEBPACK_IMPORTED_MODULE_2__.env.TERM_PROGRAM === 'Terminus-Sublime'
		|| node_process__WEBPACK_IMPORTED_MODULE_2__.env.TERM_PROGRAM === 'vscode'
		|| node_process__WEBPACK_IMPORTED_MODULE_2__.env.TERM === 'xterm-256color'
		|| node_process__WEBPACK_IMPORTED_MODULE_2__.env.TERM === 'alacritty'
		|| node_process__WEBPACK_IMPORTED_MODULE_2__.env.TERMINAL_EMULATOR === 'JetBrains-JediTerm';
}
...
function stringWidth(str) {
  if (!Intl.Segmenter) {
    return (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .stripAnsi */ .vp)(str).length;
  }
  return stringWidth$1(str);
}
class FancyReporter extends _consola_06ad8a64_mjs__WEBPACK_IMPORTED_MODULE_1__.B {
  formatStack(stack) {
    return "\n" + (0,_consola_06ad8a64_mjs__WEBPACK_IMPORTED_MODULE_1__.p)(stack).map(
      (line) => "  " + line.replace(/^at +/, (m) => _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.gray */ .O9.gray(m)).replace(/\((.+)\)/, (_, m) => `(${_utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.cyan */ .O9.cyan(m)})`)
    ).join("\n");
  }
  formatType(logObj, isBadge, opts) {
    ...
    if (isBadge) {
      return getBgColor(typeColor)(
        _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.black */ .O9.black(` ${logObj.type.toUpperCase()} `)
      );
    }
  ...
  formatLogObj(logObj, opts) {
    ...
    if (logObj.type === "box") {
      return (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .box */ .BZ)(
        characterFormat(
    ...
    const coloredDate = date && _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.gray */ .O9.gray(date);
    const isBadge = logObj.badge ?? logObj.level < 2;
    const type = this.formatType(logObj, isBadge, opts);
    const tag = logObj.tag ? _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.gray */ .O9.gray(logObj.tag) : "";
    let line;
    const left = this.filterAndJoin([type, characterFormat(message)]);
    const right = this.filterAndJoin(opts.columns ? [tag, coloredDate] : [tag]);
    const space = (opts.columns || 0) - stringWidth(left) - stringWidth(right) - 2;
    line = space > 0 && (opts.columns || 0) >= 80 ? left + " ".repeat(space) + right : (right ? `${_utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.gray */ .O9.gray(`[${right}]`)} ` : "") + left;
...
function characterFormat(str) {
  return str.replace(/`([^`]+)`/gm, (_, m) => _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.cyan */ .O9.cyan(m)).replace(/\s+_([^_]+)_\s+/gm, (_, m) => ` ${_utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.underline */ .O9.underline(m)} `);
}
function getColor(color = "white") {
  return _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors */ .O9[color] || _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.white */ .O9.white;
}
function getBgColor(color = "bgWhite") {
  return _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors */ .O9[`bg${color[0].toUpperCase()}${color.slice(1)}`] || _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .colors.bgWhite */ .O9.bgWhite;
}
...
function createConsola(options = {}) {
  ...
  const consola2 = (0,_core_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createConsola */ .eK)({
    level,
    defaults: { level },
    stdout: process.stdout,
    stderr: process.stderr,
    prompt: (...args) => __nccwpck_require__.e(/* import() */ 315).then(__nccwpck_require__.bind(__nccwpck_require__, 1315)).then((m) => m.prompt(...args)),
    reporters: options.reporters || [
      options.fancy ?? !(isCI || isTest) ? new FancyReporter() : new _consola_06ad8a64_mjs__WEBPACK_IMPORTED_MODULE_1__.B()
    ],
    ...options
  });
  return consola2;
...
function _getDefaultLogLevel() {
  if (isDebug) {
    return _core_mjs__WEBPACK_IMPORTED_MODULE_0__/* .LogLevels.debug */ .B$.debug;
  }
  if (isTest) {
    return _core_mjs__WEBPACK_IMPORTED_MODULE_0__/* .LogLevels.warn */ .B$.warn;
  }
  return _core_mjs__WEBPACK_IMPORTED_MODULE_0__/* .LogLevels.info */ .B$.info;
}
...
var node_tty__WEBPACK_IMPORTED_MODULE_0___namespace_cache;
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "BZ": () => (/* binding */ box),
/* harmony export */   "O9": () => (/* binding */ colors),
/* harmony export */   "vp": () => (/* binding */ stripAnsi)
/* harmony export */ });
/* unused harmony exports align, centerAlign, colorize, getColor, leftAlign, rightAlign */
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(5997);
...
// EXTERNAL MODULE: ./node_modules/consola/dist/utils.mjs
var utils = __nccwpck_require__(1245);
...
// EXTERNAL MODULE: ./node_modules/consola/dist/shared/consola.36c0034f.mjs
var consola_36c0034f = __nccwpck_require__(9128);
// EXTERNAL MODULE: ./node_modules/consola/dist/core.mjs
var core = __nccwpck_require__(1316);
// EXTERNAL MODULE: ./node_modules/consola/dist/shared/consola.06ad8a64.mjs
var consola_06ad8a64 = __nccwpck_require__(3307);
// EXTERNAL MODULE: external "node:process"
var external_node_process_ = __nccwpck_require__(7742);
// EXTERNAL MODULE: external "node:tty"
var external_node_tty_ = __nccwpck_require__(5997);
...
;// CONCATENATED MODULE: ./node_modules/listhen/dist/shared/listhen.9782f9b0.mjs
...
const listhen_9782f9b0_open = (target, options = {}) => {
...
listhen_9782f9b0_open.apps = apps;
listhen_9782f9b0_open.openApp = openApp;
...
async function resolveCert(options, host) {
  ...
  const { generateCA, generateSSLCert } = await __nccwpck_require__.e(/* import() */ 47).then(__nccwpck_require__.bind(__nccwpck_require__, 1047));
...
function formatURL(url) {
  return utils/* colors.cyan */.O9.cyan(
    utils/* colors.underline */.O9.underline(
      decodeURI(url).replace(/:(\d+)\//g, `:${utils/* colors.bold */.O9.bold("$1")}/`)
    )
  );
}
async function createImporter(input, _cwd) {
  const cwd = resolve(_cwd ? fileURLToPath(_cwd) : ".");
  const jiti = await __nccwpck_require__.e(/* import() */ 381).then(__nccwpck_require__.t.bind(__nccwpck_require__, 8381, 19)).then((r) => r.default || r);
...
async function listen(handle, options_ = {}) {
  ...
  const showURL = (options) => {
    const add = options_.clipboard ? utils/* colors.gray */.O9.gray("(copied to clipboard)") : "";
    const lines = [];
  ...
  const _open = async () => {
    await listhen_9782f9b0_open(getURL()).catch(() => {
    });
  };
  if (options_.open) {
    await _open();
...
async function listenAndWatch(input, options = {}) {
